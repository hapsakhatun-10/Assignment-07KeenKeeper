...
const FriendsCard = ({ data }) => {
  ...
  return (
    <div
      onClick={() => navigate(`/friendscard/${data.id}`)}
      className="bg-white rounded-2xl shadow-lg p-5 flex flex-col items-center text-center gap-3 cursor-pointer hover:shadow-xl transition"
    >
      <img
        src={data.picture}
        alt={data.name}
